<?php
/* Smarty version 3.1.30-dev/72, created on 2016-07-08 06:45:15
  from "/home/xopher/www/superdomx.com/x/X/xVitals/index.tpl" */

/* @var Smarty_Internal_Template $_smarty_tpl */
if ($_smarty_tpl->_decodeProperties($_smarty_tpl, array (
  'version' => '3.1.30-dev/72',
  'unifunc' => 'content_577f2fdb843238_75428551',
  'has_nocache_code' => false,
  'file_dependency' => 
  array (
    '7130ab2ebfb47761a5e76b1007a453079fdd1d7b' => 
    array (
...
function content_577f2fdb843238_75428551 (Smarty_Internal_Template $_smarty_tpl) {
?>
...
>
    ...
    <?php $_smarty_tpl->_assignInScope('js', "/x/html/layout/watchtower/js");
?>
    <!-- page libs -->
    <?php echo '<script'; ?>
 src="<?php echo $_smarty_tpl->tpl_vars['js']->value;?>
/nvd3-custom-lb1.0/lib/d3.v2.min.js"><?php echo '</script'; ?>
>
    <?php echo '<script'; ?>
 src="<?php echo $_smarty_tpl->tpl_vars['js']->value;?>
/nvd3-custom-lb1.0/nv.d3.custom.js"><?php echo '</script'; ?>
>

    <!-- nvd3 models -->
    <?php echo '<script'; ?>
 src="<?php echo $_smarty_tpl->tpl_vars['js']->value;?>
/nvd3-custom-lb1.0/src/models/scatter.js"><?php echo '</script'; ?>
>
    <?php echo '<script'; ?>
 src="<?php echo $_smarty_tpl->tpl_vars['js']->value;?>
/nvd3-custom-lb1.0/src/models/axis.js"><?php echo '</script'; ?>
>
    <?php echo '<script'; ?>
 src="<?php echo $_smarty_tpl->tpl_vars['js']->value;?>
/nvd3-custom-lb1.0/src/models/legend.js"><?php echo '</script'; ?>
>
    <?php echo '<script'; ?>
 src="<?php echo $_smarty_tpl->tpl_vars['js']->value;?>
/nvd3-custom-lb1.0/src/models/stackedArea.js"><?php echo '</script'; ?>
>
    <?php echo '<script'; ?>
 src="<?php echo $_smarty_tpl->tpl_vars['js']->value;?>
/nvd3-custom-lb1.0/src/models/stackedAreaChart.js"><?php echo '</script'; ?>
>
    <?php echo '<script'; ?>
 src="<?php echo $_smarty_tpl->tpl_vars['js']->value;?>
/nvd3-custom-lb1.0/src/models/line.js"><?php echo '</script'; ?>
>
    <?php echo '<script'; ?>
 src="<?php echo $_smarty_tpl->tpl_vars['js']->value;?>
/nvd3-custom-lb1.0/src/models/pie.js"><?php echo '</script'; ?>
>
    <?php echo '<script'; ?>
 src="<?php echo $_smarty_tpl->tpl_vars['js']->value;?>
/nvd3-custom-lb1.0/src/models/pieChartTotal.js"><?php echo '</script'; ?>
>
    <?php echo '<script'; ?>
 src="<?php echo $_smarty_tpl->tpl_vars['js']->value;?>
/nvd3-custom-lb1.0/stream_layers.js"><?php echo '</script'; ?>
>
    <?php echo '<script'; ?>
 src="<?php echo $_smarty_tpl->tpl_vars['js']->value;?>
/nvd3-custom-lb1.0/src/models/lineChart.js"><?php echo '</script'; ?>
>
    <?php echo '<script'; ?>
 src="<?php echo $_smarty_tpl->tpl_vars['js']->value;?>
/nvd3-custom-lb1.0/src/models/multiBar.js"><?php echo '</script'; ?>
>
    <?php echo '<script'; ?>
 src="<?php echo $_smarty_tpl->tpl_vars['js']->value;?>
/nvd3-custom-lb1.0/src/models/multiBarChart.js"><?php echo '</script'; ?>
>
