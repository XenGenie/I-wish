<?php /* Smarty version Smarty-3.1.19-dev, created on 2016-05-29 23:57:46
         compiled from "/home/xopher/www/superdomx.com/x/html/layout/iframe/boss.door.tpl" */ ?>
<?php /*%%SmartyHeaderCode:885462684574b65da6f75c7-54375946%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    'fb7443487944cce13f12d8c30b9755d362657039' => 
    array (
      0 => '/home/xopher/www/superdomx.com/x/html/layout/iframe/boss.door.tpl',
      1 => 1448769400,
      2 => 'file',
    ),
  ),
  'nocache_hash' => '885462684574b65da6f75c7-54375946',
  'function' => 
  array (
  ),
  'variables' => 
  ...
  'unifunc' => 'content_574b65dad81140_32620505',
),false); /*/%%SmartyHeaderCode%%*/?>
<?php if ($_valid && !is_callable('content_574b65dad81140_32620505')) {function content_574b65dad81140_32620505($_smarty_tpl) {?><!DOCTYPE html>
<html lang="en">
	<head>
		<meta charset="utf-8"> 
...
<?php $_tmp3=ob_get_clean();?><?php $_smarty_tpl->tpl_vars['XTRA_METHOD'] = new Smarty_variable($_smarty_tpl->getSubTemplate ("../../../".((string)$_smarty_tpl->tpl_vars['suite']->value)."/x".$_tmp3."/".((string)$_smarty_tpl->tpl_vars['method']->value).".tpl", $_smarty_tpl->cache_id, $_smarty_tpl->compile_id, 0, null, array(), 0));?>
...
<?php $_tmp4=ob_get_clean();?><?php if ($_smarty_tpl->tpl_vars['walk']->value==$_smarty_tpl->tpl_vars['path']->value[$_tmp4]) {?>active<?php }?>btn btn-success  ">
										<?php if ($_smarty_tpl->tpl_vars['walk']->value=='/') {?>
 ...
 --> 
        ...
        <script type="text/javascript">
        window.loadIframe = function  (f) {
       	    var l = location.href;
        	f.attr('src', l.replace('/<?php echo $_smarty_tpl->tpl_vars['toGodDoor']->value;?>
/','/' )); 
        	// body...
        }
        ...
        $(document).ready(function(){
        	...
        	window.loadIframe($('#iframe'));
        });
 
        </script>
        
        <iframe id="iframe" src="//<?php echo $_smarty_tpl->tpl_vars['HTTP_HOST']->value;?>
