<?php
/* Smarty version 3.1.30-dev/72, created on 2016-06-16 08:05:09
  from "/home/xopher/www/superdomx.com/x/html/layout/watchtower/js/tables-dynamic.js" */

/* @var Smarty_Internal_Template $_smarty_tpl */
if ($_smarty_tpl->_decodeProperties($_smarty_tpl, array (
  'version' => '3.1.30-dev/72',
  'unifunc' => 'content_57624195618753_59313979',
  'has_nocache_code' => false,
  'file_dependency' => 
  array (
    '2e4165a54a66a810b23f4fd033a77b652b182677' => 
    array (
      0 => '/home/xopher/www/superdomx.com/x/html/layout/watchtower/js/tables-dynamic.js',
      1 => 1466057101,
      2 => 'file',
    ),
  ),
...
function content_57624195618753_59313979 (Smarty_Internal_Template $_smarty_tpl) {
?>
    function pageLoad(){
      alert('Page Loaded');
        //Backgrid part
        ...
        function createBackgrid(collection){
            ...
            var pageableGrid = new Backgrid.Grid({
                ...
                footer: Backgrid.Extension.Paginator.extend({
                    ...
                    template: _.template('<tr><td colspan="<?php echo '<%';?>= colspan <?php echo '%>';?>"><ul class="pagination"><?php echo '<%';?> _.each(handles, function (handle) { <?php echo '%>';?><li <?php echo '<%';?> if (handle.className) { <?php echo '%>';?>class="<?php echo '<%';?>= handle.className <?php echo '%>';?>"<?php echo '<%';?> } <?php echo '%>';?>><a href="#" <?php echo '<%';?> if (handle.title) { <?php echo '%>';?> title="<?php echo '<%';?>= handle.title <?php echo '%>';?>"<?php echo '<%';?> } <?php echo '%>';?>><?php echo '<%';?>= handle.label <?php echo '%>';?></a></li><?php echo '<%';?> }); <?php echo '%>';?></ul></td></tr>')
                }),
