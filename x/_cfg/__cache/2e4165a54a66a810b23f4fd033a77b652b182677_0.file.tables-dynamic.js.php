...
function content_57624a2c2bdda2_55514619 (Smarty_Internal_Template $_smarty_tpl) {
?>
$(function(){
    function initBackgrid(){
        ...
        var PageableTerritories = Backbone.PageableCollection.extend({
            model: Territory,
            url: "/x/html/layout/watchtower/js/json/pageable-territories.json",
            state: {
                pageSize: 9
            },
    ...
    function initDataTables(){ 
      if(typeof(window.initDataTables) != 'undefined'){
        return true;
      }
        window.initDataTables = true;
